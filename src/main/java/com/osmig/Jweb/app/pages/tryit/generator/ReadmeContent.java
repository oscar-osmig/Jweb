...
/** Hardcoded complete README content for the starter project. */
...
```java
import static com.jweb.framework.styles.MediaQuery.*;
...
```java
import static com.jweb.framework.styles.Keyframes.*;
...
```java
import static com.jweb.framework.styles.Supports.*;
...
```java
import static com.jweb.framework.js.Actions.*;
...
```java
import com.jweb.framework.state.State;
...
```java
import static com.jweb.framework.db.mongo.Mongo.*;
...
```java
import com.jweb.framework.security.Jwt;
...
```java
import com.jweb.framework.security.Csrf;
...
```java
import com.jweb.framework.security.Password;
...
```java
import static com.jweb.framework.validation.Validators.*;
...
```java
import com.jweb.framework.validation.FormValidator;
...
```java
import com.jweb.framework.i18n.I18n;
import com.jweb.framework.i18n.Messages;
...
```java
import com.jweb.framework.upload.FileUpload;
...
```java
import com.jweb.framework.email.Email;
import com.jweb.framework.email.Mailer;
...
```java
import com.jweb.framework.async.Jobs;
import com.jweb.framework.async.Scheduler;
...
```java
import com.jweb.framework.health.Health;
...
```java
import com.jweb.framework.testing.JWebTest;
import com.jweb.framework.testing.TestClient;
...
```java
import com.jweb.framework.accessibility.A11y;
...
```java
import com.jweb.framework.performance.Prefetch;
