...
// Optional end() instead of otherwise() (renders nothing if no match)
when(isSpecialUser)
    .then(specialBadge())
    .elif(isPremium, premiumBadge())
    .end()
```
